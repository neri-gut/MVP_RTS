...
@export var team_id : int = 0  # 0 = Jugador, 1 = Enemigo, 2 = Aliado Neutro
@export var unit_name : String = "Units"
...
func _ready():
	...
	if has_node("Components/SelectionComponent"):
		...
		# TODO: Refactorizar ya que todos los personajes tendran este Nodo solo que el jugador no podra seleccionar grupos diferentes
		pass
